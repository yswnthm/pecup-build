...
function AppleHelloEnglishEffect({
  ...
  return (
    ...
    >
      ...
      {/* esh */}
      <motion.path
        d="M60 120 C40 90 100 90 100 110 C100 130 60 130 70 140 C80 150 120 150 130 140 C140 100 160 100 160 110 C160 120 140 130 140 140 C140 150 170 150 180 140 C190 130 210 40 220 40 L220 150 C220 110 260 110 260 150"
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
